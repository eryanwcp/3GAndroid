package com.eryansky.common.net;
 ...
 * @date 2012-4-24 下午03:34:01
 */
public final class HttpHelper {
    public final static String TAG = "HttpHelper";
 
    private final static String DAFAULT_ENCODING = "UTF-8";
    ...
    /**
     * 以GET方法新建一个线程获取网页，编码方式为 DAFAULT_ENCODING，超时或编码错误返回null
     * 
     * @param strUrl
     *            网页URL地址
     * @param handler
    ...
    public void getHtmlByThread(String strUrl, Handler handler, int what) {
        getHtmlByThread(strUrl, null, false, DAFAULT_ENCODING, handler, what);
    }
    ...
    /**
     * 以GET方法获取网页，编码方式为 DAFAULT_ENCODING，超时或编码错误返回null
     * 
     * @param strUrl
     *            网页URL地址
     * @return 返回网页的字符串
    ...
    public String getHtml(String strUrl) {
        return getHtml(strUrl, null, false, DAFAULT_ENCODING);
    }
