...
/**
 * 在图标上显示联系人数量 （G13真机测试异常 模拟器2.2正常）
 * @author 尔演&Eryan eryanwcp@163.com
 * @date 2011-12-7 上午08:47:51 
 *
 */
public class NotificationIconActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notificationicon);
        mImageView=(ImageView)findViewById(R.id.notifictionicon_icon);
        ...
        if(contactIcon instanceof BitmapDrawable){
        	...
        	//icon=getResIcon(getResources(), R.drawable.ic_launcher);
        	icon=getResIcon(getResources(), R.id.notifictionicon_icon);
        }
    ...
    private void showNotifacation(Bitmap icon){
    	Notification notification=new  Notification(R.drawable.ic_launcher,"联系人数量",System.currentTimeMillis());
    	//使用RemoteView自定义通知视图
